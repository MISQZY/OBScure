...
function SheetContent({
  ...
  /**
   * Portal target. Defaults to document.body (viewport-fixed, as usual for a
   * sheet). Pass a specific element to confine the sheet (and its overlay) to
   * that element's bounds instead of the whole window, via absolute
   * positioning relative to it (that element must be a positioned ancestor,
   * e.g. `relative`).
   */
